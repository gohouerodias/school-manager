...
class StoreEleveRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            // system and typed in by staff whenever they have it on hand, so
            // it's optional and may be filled in later via "Modifier la fiche".
            'matricule' => ['nullable', 'string', 'max:100', 'unique:eleves,matricule'],
